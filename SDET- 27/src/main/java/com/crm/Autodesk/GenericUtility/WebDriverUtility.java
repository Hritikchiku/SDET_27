...
/**
 * wait for page to load before indentifing any sychronized element in DOM[HTML_Document]
 * @param driver
 */
	...
	/**
	 * wait for page to load before identifing any synchronized element [java Script action]element in DOM [HTML-Document]
	 * @param driver
	 */
	 ...
	 * @throws Exception 
	 */
	public void waitForElementWithCustomTimeOut(WebDriver driver ,WebElement element ,int pollingTime  ) throws Exception {
	...
	/**
	 * Used To Switch To Any Windows Based On Window Titile
	 * @param driver
